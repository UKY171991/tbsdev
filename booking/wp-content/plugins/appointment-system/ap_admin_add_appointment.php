<?php
function wps_theme_func_addnew_admin()
{ 
	global $wpdb;
	        ...
	        <table class="table newappoinyment">
			  ...
			  <div style="display:none;" id="image"><img width="50" src="<?php echo AP_PLUGIN_DIR?>/assets/images/loder_gif.gif"></div>
				 ...
				 <tr>
					...
					<div class="new" ></div>
					<div id="add" class="text-center"  onclick="myFunction()"><a href="javascript:void(0)" class="text-center btn btn-info ">Add Service</a></div>
...
<script type="text/javascript">
	...
	$("#term").click(function(){
		swal('By ticking the box you will be bound by our terms and conditions ');
	});
					 ...
					 // checking service service duplicate  start
					  ...
					  //var closecl=1;
						if(number_service_1 !='' && content_new_1 !=''){
							...
							swal("Pleae select service  and service no.");
						}
      ...
      success: function(datas)
        {
			...
			swal('Booking Update successfully');
				...
				swal('Booking submit successfully');
				location.reload();
			}
