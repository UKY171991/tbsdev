...
// If transaction data is available in the URL 
	if( !empty($_GET['tx']) && !empty($_GET['amt']) && !empty($_GET['cc']) && !empty($_GET['st'])){ 
		...
		$payment_status = $_GET['st']; 
		 ...
		 $paymentRow = $wpdb->get_results("SELECT * FROM $ap_payment WHERE txn_id ='$item_number'"); 
			...
			$query="INSERT INTO  $ap_payment (item_number,booking_id,txn_id,payment_amount,payment_currency,payment_status) VALUES ('$item_number','$item_name','$txn_id','$payment_gross','$currency_code','$payment_status')";
			$wpdb->query($query);
			...
			$PaymentResult = $wpdb->get_results("SELECT * FROM $ap_payment WHERE booking_id = '".$item_name."'"); //$payment_id
	...
	<div class="row">
		<div class="status">
			<?php if(!empty($item_name)){ ?>
				...
				<p><b>Reference Number :</b> <?php echo $item_name; ?></p>
