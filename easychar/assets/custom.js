...
if(blankp == ''){
    ...
    $('.nit-products .nit-products-box .nit-flex').append('<span class="marker2"></span>');
...
//            marker.css('width','0');
    ...
    $('body').on('mouseenter','.nit-products .nit-products-box .nit-flex .nit-box',function(e){
            
            var marker = $('.marker2');
            var ssa = $('.nit-products .nit-products-box .nit-flex .nit-box').get(0);
            var ss = $(this).get(0);
            var nav = document.querySelector('.nit-products .nit-products-box .nit-flex');
            var width = ss.offsetWidth;
            var left = ss.offsetLeft;
            marker.css('left',left+'px');
            marker.css('width',width+'px');
        ...
        $('body').on('mouseleave','.nit-products .nit-products-box .nit-flex .nit-box',function(e){
           var marker = $('.marker2');
            var ssa = $('.nit-products .nit-products-box .nit-flex .nit-box').get(0);
            var ss = $(this).get(0);
            var nav = document.querySelector('.nit-products .nit-products-box .nit-flex .nit-box');
            var width = ss.offsetWidth;
            var left = ss.offsetLeft;
            marker.css('left',' ');
            marker.css('opacity','0');
