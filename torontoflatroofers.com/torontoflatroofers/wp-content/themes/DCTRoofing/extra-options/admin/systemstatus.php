...
<div class="porto_mini_status">
	...
	<ul class="system-status">
		...
		<li>
			<span class="label"><?php esc_html_e( 'Uploads folder writable', 'dctonepage' ) ?></span>
		...
		<li>
			<span class="label"><?php esc_html_e( 'WP File System', 'dctonepage' ) ?></span>
			<?php if( $status['fs'] ): ?>
				<span class="status yes dashicons dashicons-yes"></span>
			<?php else: ?>
				<span class="status no dashicons dashicons-no"></span>
		...
		<li>
			<span class="label"><?php esc_html_e( 'ZipArchive', 'dctonepage' ) ?></span>
			<?php if( $status['zip'] ): ?>
				<span class="status yes dashicons dashicons-yes"></span>
			<?php else: ?>
				<span class="status no dashicons dashicons-no"></span>
		...
		<?php if( $status[ 'suhosin' ] ): ?>
			...
			<li>
				<span class="label"><?php esc_html_e( 'SUHOSIN Installed', 'dctonepage' ) ?></span>
		...
		<?php else: ?>
			...
			<li>
				<span class="label"><?php esc_html_e( 'PHP Memory Limit', 'dctonepage' ) ?></span>
			...
			<li>
				<span class="label"><?php esc_html_e( 'PHP max_execution_time', 'dctonepage' ) ?></span>
			...
			<li>
				<span class="label"><?php esc_html_e( 'PHP max_input_vars', 'dctonepage' ) ?></span>
